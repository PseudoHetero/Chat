...
function subscribe(uri) {
  ...
  function connect(uri) {
    ...
    events.addEventListener("error", () => {
      ...
      console.log(`conexão perdida. tentando reconectar em :${timeout} segundos`);
...
function setConnectedStatus(status) {
  ...
  statusDiv.className = (status) ? "conectado" : "reconectando";
}
...
function init() {
  ...
  addRoom("rocket");
  changeRoom("lobby");
  addMessage("lobby", "Rocket", "Opa! Abre outra aba e manda uma mensagem", true);
  addMessage("rocket", "Rocket", "Esse é a maneiríssimo, outra sala?", true);
  ...
  newRoomForm.addEventListener("submit", (e) => {
    ...
    addMessage(room, "Rocket", `Parabens por criar "${room}"!`, true);
  })
